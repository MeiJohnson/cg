...
class Ui_mainWindow(object):
    def setupUi(self, mainWindow):
        ...
        self.drawWindow = QtWidgets.QFrame(self.centralwidget)
        self.drawWindow.setGeometry(QtCore.QRect(50, 30, 400, 300))
        self.drawWindow.setMinimumSize(QtCore.QSize(400, 300))
        self.drawWindow.setMaximumSize(QtCore.QSize(400, 300))
        self.drawWindow.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.drawWindow.setFrameShadow(QtWidgets.QFrame.Raised)
